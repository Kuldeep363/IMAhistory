...
<html>
    ...
    <body>
	 <div class="container d-flex justify-content-center">
			...
			<form action="./registrationinsert_hos.php" method="post" class="ml-3 d-flex justify-content-center">
			<div class="formbody">
				...
				<div class="form-group">	
					<label for="hosname" class="form-label ml-1">Hospital name</label>
					<input type="text" id="hosname" class="form-control ml-1" name="hosname" required>
				</div>
