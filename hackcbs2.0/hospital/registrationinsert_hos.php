...
//   $gender=$_POST['gender'];
  ...
  $username=$_POST['username'];
	// echo $username;
  $query = "UPDATE  hospital SET `hos_name`=:firstname,`hos_email`=:email,`hos_address`=:adress,`hos_contact`=:mob
  WHERE `hos_username`=:username";
    // prepare query statement
  $stmt = $conn->prepare($query);
    // sanitize
  	$hosname=strip_tags($hosname);
    ...
    $username=strip_tags($username);
      // bind valuesj
  	$stmt->bindParam(":firstname", $hosname);
...
//	  header('location:loginform.php');
    ...
    $userInput=$username;
      ...
      <tr><td><strong>Hospital Name</strong></td><td>:".$hosname."</td></tr>
      ...
      Login anytime to update the medical history of patients<br>
      Thank you  (-_-)
      </body></html>";
