...
try {
  ...
  $query = "SELECT * FROM hospital  WHERE hos_username=:username";
  ...
  if($password2==$password){
    $query = "INSERT INTO hospital (hos_username,hos_pas) VALUES (:username,:pass)";
    ...
    echo "<script>location.href='registration_hos.php'</script>";
