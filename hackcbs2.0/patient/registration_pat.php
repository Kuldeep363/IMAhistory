...
<html>
    ...
    <body>
	 <div class="container d-flex justify-content-center">
			...
			<form action="./registrationinsert_pat.php" method="post" class="ml-3 d-flex justify-content-center">
			<div class="formbody">	
				...
				<div class="form-group">	
					<label for="firstname" class="form-label ml-1">First name</label>
					<input type="text" id="firstname" class="form-control ml-1" name="firstname" required>
				</div>
				<div class="form-group">	
					<label for="lastname" class="form-label ml-1">Last name</label>
					<input type="text" id="lastname" class="form-control ml-1" name="lastname" required>
				</div>
				<div class="form-group">	
					<label for="age" class="form-label ml-1">Age</label>
					<input type="number" id="age" class="form-control ml-1" name="age" max="120" min="1" pattern="[0-9]" required>
				</div>
				<div class="form-inline ml-1">Gender
					<div class="custom-control custom-radio ml-4">	
						<input type="radio" id="male" class="custom-control-input" name="gender" value="male" required>
						<label for="male" class="custom-control-label">Male</label>
					</div>	
					<div class="custom-control custom-radio ml-2">
						<input type="radio" id="female" class="custom-control-input" name="gender" value="female" required>
						<label for="female" class="custom-control-label">Female</label>
					</div>
					<div class="custom-control custom-radio ml-2">
						<input type="radio" id="custom" class="custom-control-input" name="gender" value=" custom" required>
