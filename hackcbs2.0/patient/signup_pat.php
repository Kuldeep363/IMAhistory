...
try {
  ...
  $query = "SELECT * FROM patient  WHERE pat_username=:username";
  ...
  if($password2==$password){
    $query = "INSERT INTO patient (pat_username,pat_pass) VALUES (:username,:pass)";
    ...
    echo "<script>location.href='registration_pat.php'</script>";
